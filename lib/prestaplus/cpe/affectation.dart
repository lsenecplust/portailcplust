...
class AffectationCPE extends StatefulWidget {
  final Prestation prestation;
  const AffectationCPE({
    Key? key,
    required this.prestation,
  }) : super(key: key);

  @override
  State<AffectationCPE> createState() => _AffectationCPEState();
}

class _AffectationCPEState extends State<AffectationCPE> {
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            TextFormField(
              focusNode: macNode,
              controller: macadrress,
              decoration: const InputDecoration(label: Text("Adresse MAC")),
            ),
